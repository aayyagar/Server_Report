...
$xmlnsGpSettings = "https://www.microsoft.com/en-us/download/details.aspx?id=56946";
...
{                
    ...
    foreach ($extensionNode in $extensionNodes)
        ...
        if ([String]::Compare(($extensionNode.Attributes.Item(0)).Value, 
            "https://www.microsoft.com/en-us/download/details.aspx?id=56946" + $Extension, $true) -eq 0)
        {
