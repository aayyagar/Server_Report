...
$Accounts = Import-Csv C:\Server\Users.csv
#if your csv does not have headers 
#$Accounts = Import-Csv C:\Server\Users.csv -Header @("DisplayName","Userprincipalname","givenname","sn","SamAccountName","Name","employeeID")
